      ...
      <div className="mx-auto w-full py-10">
        <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-col gap-3">
            <Link
              href="/"
              className="inline-block w-fit transition-opacity hover:opacity-90"
            >
              <Image
                src="/logo-nome.png"
                alt="Intoxi Anime"
          ...
          <div className="flex flex-col gap-3 md:items-end">
            ...
            <div className="flex items-center gap-3">
              {/* YouTube */}
              <a
                href="https://www.youtube.com/@IntoxiAnime"
                target="_blank"
              ...
              {/* Instagram */}
              <a
                href="https://instagram.com/marcoabreu00"
                target="_blank"
                rel="noopener noreferrer"
              ...
              {/* X / Twitter */}
              <a
                href="https://x.com/blogintoxianime"
                target="_blank"
                rel="noopener noreferrer"
              ...
              {/* Facebook */}
              <a
                href="https://facebook.com/intoxianime"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
              ...
              {/* Discord */}
              <a
                href="https://discord.gg/intoxianime"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Discord"
